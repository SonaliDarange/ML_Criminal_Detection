...
def identify_criminal(image_path):
    ...
    for name, details in database.items():
        ...
        if distance < 10:
            ...
            # ✅ Ensure the name is stored correctly
            details_with_name = {**details, "name": name}
            return f"Match found: {name}", details_with_name
            ...
            for name, details in database.items():
                ...
                if distance < 10:
                    ...
                    with lock:
                        ...
                        # ✅ Properly set details with name
                        last_match_info["details"] = {**details, "name": name}
                    matched = True
                    break
